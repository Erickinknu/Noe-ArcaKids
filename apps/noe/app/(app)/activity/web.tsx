...
export default function WebActivityScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.screen, { paddingTop: screenPadding.paddingTop }]}>
      ...
      <EmptyState
        icon="🌐"
        title="Aún no hay datos de páginas web"
        description="El historial de navegación aparecerá aquí cuando la app del dispositivo de tu hijo reporte esta información."
      />
    </ScrollView>
  );
}
