...
export default function ConversationsScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.screen, { paddingTop: screenPadding.paddingTop }]}>
      ...
      <EmptyState
        icon="✉️"
        title="Aún no hay datos de conversaciones"
        description="Las conversaciones aparecerán aquí cuando la app del dispositivo de tu hijo reporte esta información."
      />
    </ScrollView>
  );
}
