...
export default function AppsScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.screen, { paddingTop: screenPadding.paddingTop }]}>
      ...
      <Text style={styles.description}>Aplicaciones instaladas en el dispositivo de tu hijo.</Text>

      <EmptyState
        icon="📱"
        title="Aún no hay datos de apps"
        description="Las aplicaciones instaladas aparecerán aquí cuando la app del dispositivo de tu hijo reporte esta información."
      />
    </ScrollView>
  );
}
