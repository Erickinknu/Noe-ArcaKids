export const en = {
  ...
  noe: {
    ...
    dashboard: {
      ...
      adjustLimitTitle: 'Adjust time limit',
      adjustLimitHint: 'Choose how much time the device can be used each day.',
      currentLimit: 'Current limit',
      noLimit: 'No limit',
      setLimit: 'Save limit',
      setLimitConfirm: 'Set {{name}}\u2019s limit to {{minutes}} min per day?',
      removeLimit: 'Remove limit',
      removeLimitConfirm:
        'Remove {{name}}\u2019s daily limit? They will be able to use the device without a limit.',
      removeLimitConfirmButton: 'Remove',
