export const es = {
  ...
  validation: {
    ...
    birthDateInvalid: 'La fecha de nacimiento no es v\u00e1lida (AAAAMMDD).',
  ...
  noe: {
    ...
    dashboard: {
      ...
      adjustLimitTitle: 'Ajustar l\u00edmite de tiempo',
      adjustLimitHint: 'Elige cu\u00e1nto tiempo puede usar el dispositivo cada d\u00eda.',
      currentLimit: 'L\u00edmite actual',
      noLimit: 'Sin l\u00edmite',
      setLimit: 'Guardar l\u00edmite',
      setLimitConfirm: '\u00bfEstablecer el l\u00edmite de {{name}} en {{minutes}} min al d\u00eda?',
      removeLimit: 'Quitar l\u00edmite',
      removeLimitConfirm:
        '\u00bfQuitar el l\u00edmite diario de {{name}}? Podr\u00e1 usar el dispositivo sin l\u00edmite.',
      removeLimitConfirmButton: 'Quitar',
    ...
    deviceControl: {
      ...
      rootControls: 'Controles de raíz',
      rootSubtitle: 'Aplica poderes de administrador del dispositivo (requiere Device Owner):',
      kiosk: 'Modo kiosco',
      capture: 'Bloquear capturas',
      camera: 'Bloquear cámara',
      noUninstall: 'Bloquear instalar/desinstalar',
      appsTitle: 'Apps instaladas',
      appsSubtitle: 'Carga la lista real del dispositivo para bloquear, desbloquear, cerrar u ocultar.',
      loadApps: 'Cargar aplicaciones',
      noApps: 'El dispositivo aún no reportó sus aplicaciones. Pulsa "Cargar aplicaciones".',
      blockSelected: 'Bloquear ({{n}})',
      unblockSelected: 'Desbloquear',
      forceStopSelected: 'Forzar cierre',
      hideSelected: 'Ocultar',
      wipeButton: 'Borrar dispositivo',
      wipeTitle: '¿Borrar el dispositivo?',
      wipeMessage: 'Esto ejecutará un borrado remoto (wipe) y restablecerá de fábrica el dispositivo del hijo. No se puede deshacer.',
    },
    activity: {
      title: 'Actividad',
